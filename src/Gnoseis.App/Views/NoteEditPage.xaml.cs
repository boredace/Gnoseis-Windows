...
/// <summary>New / edit note.</summary>
public sealed partial class NoteEditPage : Page, IConfirmLeave
{
    public NoteEditPage()
    {
        InitializeComponent();
        Loaded += (_, _) => TitleBox.FocusText();
    }

    public NoteEditViewModel ViewModel { get; private set; } = null!;

    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        base.OnNavigatedTo(e);
        ViewModel = new NoteEditViewModel((EditRequest)e.Parameter);
